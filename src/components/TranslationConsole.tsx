    ...
    <div className="bg-pitch-dark/80 border border-moss-dark/60 rounded-lg overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.3)] relative">
      ...
      <div className="p-5 flex flex-col space-y-5">
        ...
        <div className="bg-pitch-black border border-moss-dark/70 rounded-xl p-4.5 space-y-3.5 relative overflow-hidden shadow-inner">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-1.5">
              <Activity className={`w-3.5 h-3.5 ${isListening ? 'text-rose-500 animate-pulse' : 'text-pale-mint'}`} />
              <span className="text-[10px] font-mono font-bold text-pale-mint uppercase tracking-wider">
                Vocal & Acoustic Tone Capture
              </span>
            </div>
            {isListening && (
              <span className="bg-rose-500/10 border border-rose-500/20 text-rose-400 text-[8.5px] font-mono px-2 py-0.5 rounded-full animate-pulse font-bold">
          ...
          {isListening ? (
            <div className="flex flex-col items-center justify-center py-4 bg-pitch-dark/50 border border-rose-500/25 rounded-lg space-y-3">
              ...
              <p className="text-[10.5px] font-mono text-rose-400 font-bold animate-pulse">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between gap-2 bg-pitch-dark/50 border border-moss-dark/50 px-2.5 py-1.5 rounded-lg">
                <span className="text-[9px] font-mono text-sage-soft uppercase font-bold">Input Language:</span>
                <select 
              ...
              {micPermissionError && (
                <div className="bg-rose-950/20 border border-rose-500/30 p-2.5 rounded-lg text-[10px] font-mono text-rose-300 space-y-1">
                  <div className="font-bold flex items-center gap-1 text-rose-400">
                    <AlertTriangle className="w-3 h-3 text-rose-400 shrink-0" />
                    <span>Mic Sandboxed or Denied</span>
                  </div>
                  <p className="text-[9px] text-rose-300/85 leading-relaxed">
                    {micPermissionError}
                  </p>
              ...
              <div className="flex gap-2">
                ...
                >
                  <Mic className="w-3.5 h-3.5 text-pale-mint" />
              ...
              {voiceToneResult && (
                <div className="bg-pitch-dark/80 border border-moss-dark/60 p-3 rounded-lg space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-sage-soft">
                    <div className="bg-moss-deep/20 p-1.5 rounded border border-moss-dark/30">
                      <span className="text-[8px] text-sage-soft/60 block uppercase font-bold flex justify-between">
                        <span>EMOTION</span>
                        {voiceToneResult.isSimulated && <span className="text-amber-500/70 text-[7px] font-normal">(SIMULATED)</span>}
                      </span>
                  ...
                  <div className="flex justify-between items-center text-[8.5px] text-sage-soft/50 font-mono pt-1">
        ...
        <div className="space-y-2 pt-1 border-t border-moss-dark/30">
          <label className="text-[9px] font-mono text-sage-soft block uppercase tracking-wider font-semibold">
